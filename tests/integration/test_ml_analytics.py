...
class TestMLAnalyticsEngine:
    ...
    def sample_metrics_data(self):
        ...
        dates = pd.date_range(start=datetime.utcnow() - timedelta(hours=48), 
                             end=datetime.utcnow(), freq='5min')
    ...
    def test_historical_data_fetching(self, ml_engine):
        ...
        mock_points = [
            {'time': '2025-08-07T10:00:00Z', 'cpu_percent': 45.5, 'memory_percent': 67.2},
            {'time': '2025-08-07T10:05:00Z', 'cpu_percent': 48.1, 'memory_percent': 68.5},
            {'time': '2025-08-07T10:10:00Z', 'cpu_percent': 52.3, 'memory_percent': 65.8}
        ]
    ...
    def test_predictive_analytics(self, ml_engine, sample_metrics_data):
        ...
        try:
            ...
            if insights:
                ...
                assert prediction_insight.data_points['predicted_max'] >= prediction_insight.data_points['current_value']
    ...
    def test_performance_trend_analysis(self, ml_engine, sample_metrics_data):
        ...
        try:
            ...
            insights = ml_engine.analyze_performance_trends(
                sample_metrics_data, 
                ['memory_percent']  # Memory has growth trend
            )
            ...
            if insights:
                ...
                assert trend_insight.data_points['trend_direction'] in ['increasing', 'decreasing']
    ...
    def test_capacity_planning_analysis(self, ml_engine, sample_metrics_data):
        ...
        high_usage_data['memory_percent'] = 75 + np.linspace(0, 20, len(high_usage_data))  # Growing to critical levels
    ...
    def test_ml_model_training_and_caching(self, ml_engine, sample_metrics_data):
        ...
        if not hasattr(ml_engine, 'detect_anomalies') or not hasattr(ml_engine, 'models'):
        ...
        try:
            ...
            insights2 = ml_engine.detect_anomalies(
                sample_metrics_data, 
                ['cpu_percent']
            )
    ...
    def test_insight_generation_and_structure(self, ml_engine, sample_metrics_data):
        ...
        with patch.object(ml_engine, 'fetch_historical_data', return_value=sample_metrics_data):
            with patch.object(ml_engine, 'store_ml_insights'):
                with patch.object(ml_engine, 'send_ml_insights_notification'):
                    ...
                    if hasattr(ml_engine, 'insights_history') and ml_engine.insights_history:
                        insight = ml_engine.insights_history[0]
                        
                        # Check insight structure
                        required_attributes = [
                            'analysis_type', 'severity', 'timestamp', 'title', 
                            'description', 'confidence', 'affected_services', 
                            'recommendations', 'data_points'
                        ]
    ...
    def test_slack_notification_integration(self, ml_engine):
        ...
        with patch('requests.post') as mock_post:
            with patch.object(ml_engine, 'get_slack_webhook', 
    ...
    def test_model_performance_tracking(self, ml_engine, sample_metrics_data):
        ...
        if not hasattr(ml_engine, 'model_performance') or not hasattr(ml_engine, 'generate_predictions'):
    ...
    def test_data_preprocessing_and_feature_engineering(self, ml_engine, sample_metrics_data):
        ...
        try:
            ...
            if 'cpu_percent' in ml_engine.data_cache:
                ...
                rolling_features = {'rolling_mean_6h', 'rolling_std_6h', 'rolling_mean_24h'}
...
class TestMLAnalyticsIntegration:
    ...
    def test_influxdb_connectivity_for_ml(self):
        ...
        try:
            ...
            client = InfluxDBClient(host='localhost', port=8086, database='test_ml_analytics')
...
class TestMLModelValidation:
    ...
    def test_anomaly_detection_accuracy(self):
        ...
        try:
            ...
            true_labels = np.hstack([np.ones(1000), -np.ones(50)])  # 1 for normal, -1 for anomaly
    ...
    def test_prediction_model_accuracy(self):
        ...
        try:
            ...
            assert relative_error < 0.3, f"Prediction accuracy too low: {relative_error:.2f}"
