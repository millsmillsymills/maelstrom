...
class TestEnhancedNetworkDiscovery:
    ...
    def test_prometheus_targets_integration(self, discovery_service, tmp_path):
        ...
        test_devices = [
            ...
            },
            {
                ...
                "services": [{"port": 9104, "service": "mysql-exporter"}],
            },
        ]
    ...
    def test_influxdb_data_storage(self, discovery_service):
        ...
        if discovery_service.influxdb_client:
            with patch.object(
                discovery_service.influxdb_client, "write_points"
            ) as mock_write:
                ...
                summary_points = [
                    p for p in points if p["measurement"] == "network_discovery_summary"
                ]
    ...
    def test_network_range_scanning(self, discovery_service):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(
                returncode=0, stdout="64 bytes from 192.168.1.1: icmp_seq=1 time=1.2 ms"
            )
...
class TestDiscoveryServiceDeployment:
    ...
    def test_requirements_file(self):
        ...
        req_file = Path(
            "/home/mills/networking/collections/network-discovery/requirements.txt"
        )
